 ...
 * File Name：FilterInConfiguration.java
 *
 * ID: $Id$
 * Revision: $Rev$
 * Created: 2013-5-16
...
/**
 * 此类描述的是：TODO:期望过滤出现的字符串
 * @author: liuwenlong
 * @since : 2013-5-16
 */
public class FilterInConfiguration implements Configuration{
    ...
    public FilterInConfiguration(Class<?> clz){
        this.clz = clz;
    }
    
    public FilterInConfiguration(Class<?> clz,String...classProperties){
        this.clz = clz;
        this.classProperties = classProperties;
    }
    
    
    public FilterInConfiguration(Class<?> clz,Class<?> targetClass){
        this.clz = clz;
